...
var registerMessage = "<%= request.getAttribute("registerMessage") %>";
...
<div id=footer>
	<div id=navbar>
		<ul>
			...
			<li style="float:right"><a href="index.jsp;javascript:logoutCheck()" id=floatright>Log In</a></li>
			<li style="float:right"><a class="active" href="" id=registerButton>Register</a></li>
		</ul>
	</div>
</div>
...
<div id=content>
	<div id=innercontent>
		<div id=inputs>
			<form name=login id=inputform action="RegisterController" method="post">
	  		<br>
            ...
            Retype Password<input required type="password" id= "inputBox" name ="verifyPassword" placeholder="Retype Password"><br/> 
            <br> 
            <span id=temp2></span>
  			<input id=searchaction type="submit" value="Create my account">
			</form> 
		</div>
	</div>
</div>
...
<script>
	if(localStorage.getItem("loggedIn") == "true"){
		...
		document.getElementById("content").innerHTML = "Logged In. Log out to register.";
